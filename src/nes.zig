...
pub fn Nes(comptime Color: type) type {
    return struct {
        const Self = @This();
        ...
        pub inline fn write_u8(self: *Self, address: u16, value: u8) void {
            switch (address & 0xE000) {
                ...
                0x4000 => switch (address) {
                    ...
                    0x4003 => self.apu.write_pulse1_timer_hi(@bitCast(value)),
        ...
        pub fn create(
            allocator: std.mem.Allocator,
            draw: *const fn (y: u8, scanline: [256]Color) void,
            sampleHandler: *const fn (sample: u8) void,
        ...
        pub fn run_one_frame(self: *Self) void {
            const zone = tracy.initZone(@src(), .{ .name = "Rendering" });
            defer zone.deinit();
